    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Tautan yang Anda cari tidak tersedia atau telah dipindahkan.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-gradient-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-soft transition hover:opacity-90"
          >
            Kembali ke Beranda
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Platform URL Shortener modern untuk civitas SMA Riyadhussholihiin. Pendekkan, kelola, dan pantau tautan Anda." },
      { name: "author", content: "SMA RIYADHUSSHOLIHIIN" },
      { property: "og:title", content: "RSLink - SMA RIYADHUSSHOLIHIIN — Pemendek URL untuk Civitas SMA Riyadhussholihiin" },
      { property: "og:description", content: "Platform URL Shortener modern untuk civitas SMA Riyadhussholihiin. Pendekkan, kelola, dan pantau tautan Anda." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "RSLink - SMA RIYADHUSSHOLIHIIN — Pemendek URL untuk Civitas SMA Riyadhussholihiin" },
