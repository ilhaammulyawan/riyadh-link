...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RSLink — Pemendek URL untuk Civitas SMA Riyadhussholihiin" },
      ...
      { name: "author", content: "Mulyawan" },
      { property: "og:title", content: "RSLink — Pemendek URL untuk Civitas SMA Riyadhussholihiin" },
